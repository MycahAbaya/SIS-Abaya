...
#============================ DESIGN ==============================
        ##### FRAME #####
        LeftFrame = Frame(self.root, width=250, height=800, padx=2, bg="brown", relief=RIDGE)
        LeftFrame.pack(side=LEFT)
        topFrame = Frame(self.root, width=1350, height=30, padx=2, bg="yellow", relief=RIDGE)
        ...
        self.btnAddNew=Button(self.root, pady=1,bd=4,font=('arial',12,'bold'), padx=24, width=10, text='Add ', bg="orange",command=addStudent)
        ...
        self.btnEdit=Button(self.root, pady=1,bd=4,font=('arial',12,'bold'), padx=24, width=10, text='Edit ', bg="orange",command = editData)
